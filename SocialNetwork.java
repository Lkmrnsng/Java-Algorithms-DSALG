...
public class SocialNetwork {
	...
	if(this.friendList != null) { //Checks if the person exists in the hashmap
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		System.out.print("Input file name or file path: ");
		Scanner userInput = new Scanner(System.in);
	
		String input = userInput.next();
	
		if (!input.contains(".txt")) { // Check if the file name contains ".txt"
			input += ".txt"; // Add ".txt" to the file name
		}
	
		if (input.contains("/")) { // Check if the file name contains a file path, follow this format: "data/file.txt"
				filepath = input;
			} 
		else {
				filepath = "data/" + input; // Add "data/" to the file name
		}
		...
		if (file.exists()) { // Check if the file exists
			...
			int n = fileScanner.nextInt(); // Number of people
			int e = fileScanner.nextInt(); // Number of friendships
